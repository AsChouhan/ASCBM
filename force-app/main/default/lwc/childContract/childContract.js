...
import objectName from '@salesforce/schema/Contract__c';
...
import status from '@salesforce/schema/Contract__c.Status__c';
...
export default class ContractCustom extends LightningElement {
        ...
        getData({ accountId: this.accountid })
            .then(result => {
                ...
                for (var x of tmpData) {
                    x.attributes = { "type": "Contracts__c" };
    ...
    addRowMethod() {
        var newRow = { Id: this.countId, attributes: { "type": "Contract__c" } };
