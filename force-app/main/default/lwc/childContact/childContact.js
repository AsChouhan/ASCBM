...
import objectName from '@salesforce/schema/Contact__c';
...
import gender from '@salesforce/schema/Contact__c.pickList__c';
...
export default class CustomContact extends LightningElement {
    ...
    addRowMethod() {
        var newRow = { Id: this.countId, attributes: { "type": "Contact__c" } };
