import { LightningElement, track } from 'lwc';
 ...
 import payByCreditCard from '@salesforce/apex/PaymentGetWay.payByCreditCard';
 import payByEcheck from '@salesforce/apex/PaymentGetWay.payByEcheck';
export default class PaymentGateway extends LightningElement {
   
    pymntGatewayLogo = MyResource;
    ...
    handlePayment(){
        ...
        this.handleSpinner();
        payByCreditCard({ cardNumber : this.cardNumber, amount : this.amount, 
    ...
    handleECheckPayment(){
        ...
        this.handleSpinner();
        payByEcheck({routingNumber : this.routingNumber, accountNumber : this.accountNumber, nameOnAccount : this.nameOnAccount
        })
        .then(res=>{
            let title = res;
            this.ShowToast('Success!', title, 'success', 'dismissable');
