...
import objectName from '@salesforce/schema/Account__c';
...
import industry from '@salesforce/schema/Account__c.Industry__c';
import rating from '@salesforce/schema/Account__c.Rating__c';
...
export default class CustomAcc extends LightningElement {
    ...
    addRowMethod() {
        var newRow = { Id: this.countId, attributes: { "type": "Account__c" } };
