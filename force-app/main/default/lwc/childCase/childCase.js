...
import objectName from '@salesforce/schema/Case__c';
...
import status from '@salesforce/schema/Case__c.Status__c';
import { getPicklistValues } from 'lightning/uiObjectInfoApi';

export default class CaseCustom extends LightningElement {
    countId = 1;
    ...
    addRowMethod() {
        var newRow = { Id: this.countId, attributes: { "type": "Case__c" } };
        ...
        if (this.enableEdit == false) {
            ...
            uploadData({ updatingRecords: records })
                .then((result) => {
                    ...
                    console.log('in success part case custom and result is =>>>>->>    ');
                    console.log(result);
                    this.data = result;
                })
                .catch(error => {
